...
/// Opus plan-verification review; the only pre-existing reference to <c>ScanlineStudio.Core.Audio</c> in the
...
/// direct float-array passing every other round-trip test in <c>ScanlineStudio.Core.Sstv.Tests</c> uses --
...
public class FakeAudioEngineRoundTripTests
{
    ...
    private static readonly ScanlineStudio.Abstractions.Audio.AudioDeviceInfo FakeDevice =
