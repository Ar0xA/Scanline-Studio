...
/// and the real SSTV DSP stack (<c>ScanlineStudio.Core.Sstv</c>) running together for the first time,
...
/// (<c>ScanlineStudio.Core.Sstv.Tests.SstvRoundTripTests</c> for the DSP core; the real-hardware
