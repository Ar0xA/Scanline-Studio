...
public class SyncScanInterleaveTests
{
    ...
    private static async Task<float[]> EncodeAsync(SstvModeDefinition mode, ScanlineStudio.Core.Imaging.ArrayImageSource image)
    {
    ...
    private static ScanlineStudio.Core.Imaging.ArrayImageSource CreateGradientTestImage(int width, int height)
    {
        ...
        return new ScanlineStudio.Core.Imaging.ArrayImageSource(width, height, pixels);
    }
}
