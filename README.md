...
English and German locales ship today (`assets/locale/en.json`, `assets/locale/de.json`).
...
[w0eeemst/YONIQ](https://github.com/w0eeemst/YONIQ). It is not vendored into this repository.
