...
public interface ISstvDecoder
{
    ...
    /// held no tone at all (the sync pulse could not be found). Otherwise unclamped down to a −60 dB floor.
    /// Published by the decode thread after every line; lock-free, safe
