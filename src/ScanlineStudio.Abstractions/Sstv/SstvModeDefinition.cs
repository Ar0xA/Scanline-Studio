...
/// <summary>
/// Which family of per-line codec logic a mode needs — see <c>ScanlineStudio.Core.Sstv.ScanlineCodecFactory</c>.
...
public sealed record SstvModeDefinition(
    ...
    /// placeholder). See <c>ScanlineStudio.Core.Sstv.VisHeader.GenerateExtendedSegments</c>.</summary>
    ...
    /// <c>ScanlineStudio.Core.Sstv.VisHeader.GenerateNarrowModeSegments</c>.</summary>
