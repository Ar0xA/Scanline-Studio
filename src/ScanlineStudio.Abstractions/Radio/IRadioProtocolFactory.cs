...
/// <c>ScanlineStudio.Abstractions</c> rather than <c>ScanlineStudio.Core.Radio</c> specifically so an optional future
/// backend module (e.g. a linked-Hamlib project) can register its own factory without needing to
/// reference <c>ScanlineStudio.Core.Radio</c> at all.
///
