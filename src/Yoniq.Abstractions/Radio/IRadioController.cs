...
/// <summary>See spec/02-radio-layer.md. The single facade <c>Yoniq.Application</c> talks to regardless
...
/// — see <c>Yoniq.Abstractions.Audio.IAudioEngine</c> for the contrasting case that does need a
