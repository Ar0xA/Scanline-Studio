...
public sealed partial class OptionsSettingsService
{
    ...
    public static OptionsSnapshot Defaults { get; } = new(
        ...
        FskIdRxEnabled: new StationIdSettings().FskIdRxEnabled ?? StationIdSettings.DefaultFskIdRxEnabled,
        CwIdRxEnabled: new StationIdSettings().CwIdRxEnabled ?? StationIdSettings.DefaultCwIdRxEnabled,
    ...
    public async Task<OptionsSnapshot> LoadAsync(CancellationToken ct = default)
    {
        ...
        return new OptionsSnapshot(
            ...
            FskIdRxEnabled: stationId.FskIdRxEnabled ?? StationIdSettings.DefaultFskIdRxEnabled,
            CwIdRxEnabled: stationId.CwIdRxEnabled ?? StationIdSettings.DefaultCwIdRxEnabled,
