...
/// <c>ScanlineStudio.Core.Audio.AudioDeviceSettings.TxVolumePercent</c>'s doc comment for the full
/// explanation of this STJ limitation). Here the desired "don't touch it" default already equals not
