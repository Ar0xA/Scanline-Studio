...
/// <c>Yoniq.Settings</c> sits at the *bottom* of spec/01-architecture.md's layering diagram (below
/// even <c>Yoniq.Abstractions</c>), so it cannot reference a type defined in <c>Yoniq.Core.Radio</c>
...
/// supplying its own source-generated <c>JsonTypeInfo&lt;T&gt;</c> — <c>Yoniq.Settings</c> itself never
