...
public partial class TxImageEditorPaneView : UserControl
{
    ...
    private void OnRootKeyDown(object? sender, KeyEventArgs e)
    {
        ...
        // so a bare keystroke doesn't get hijacked). Ctrl+1..Ctrl+9 was claimed too by the Ready Rack
        // direct-fire feature (2026-09-01) -- removed 2026-09-19 ("we do not queue pictures"); this
        // plain (no-modifier) branch and its own load-only recall behavior are unaffected.
