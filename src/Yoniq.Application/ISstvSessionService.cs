...
/// <summary>Orchestrates <c>Yoniq.Abstractions.Audio.IAudioEngine</c> + <see cref="ISstvEncoder"/>/
...
/// <see cref="IWaterfallSource.Frames"/> and <c>Yoniq.Abstractions.Radio.IRadioController.StateChanges</c>
...
public interface ISstvSessionService : IAsyncDisposable
{
    ...
    /// <c>Yoniq.Core.Sstv.SstvModeRegistry.All</c> directly) so <c>Yoniq.UI</c>'s TX pane can list
    /// modes without referencing a <c>Yoniq.Core.*</c> concrete assembly (spec/09-ui.md's layering
