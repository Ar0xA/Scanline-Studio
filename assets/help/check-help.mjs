...
// Every translated guide is a subdirectory of assets/help/ holding its own index.html (R7:
// assets/help/README.md's "Updating the guide" section). English stays the root index.html.
